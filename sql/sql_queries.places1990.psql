...
-- Query 0: Extract values from Census 1990 places shapefile 

DROP TABLE IF EXISTS analysis;
SELECT name, gid, st state, pl place, placecc, arealand aland, areawat awater, area, perimeter, st_transform(geom, 5070) geom
INTO analysis
FROM places_1990
WHERE st < '60';
...
DROP TABLE IF EXISTS places_1990_metrics;
...
SELECT 
	...
	analysis.placecc AS placecc,
	analysis.aland AS aland,
	analysis.awater AS awater, 
