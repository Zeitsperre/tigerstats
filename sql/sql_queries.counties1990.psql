...
-- Query 0: Extract values from Census 1990 counties shapefile 

DROP TABLE IF EXISTS analysis;
SELECT name, gid, st state, co county, area, perimeter, st_transform(geom, 5070) geom 
INTO analysis
FROM counties_1990
WHERE st < '60';
