...
-- Query 0: Extract values from Census 2000 places shapefile 

DROP TABLE IF EXISTS analysis;
SELECT name, gid, state, plc place, lsad_trans lsad, area, perimeter, st_transform(geom, 5070) geom 
INTO analysis
FROM places_2000
WHERE state < '60';
...
DROP TABLE IF EXISTS places_2000_metrics;
