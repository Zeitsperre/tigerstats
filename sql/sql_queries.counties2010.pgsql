...
-- Query 0: Extract values from Census 2010 counties shapefile 

DROP TABLE IF EXISTS analysis;
SELECT name, gid, state, county, lsad, censusarea area, st_transform(geom, 5070) geom 
INTO analysis
FROM counties_2010
WHERE state < '60';
...
DROP TABLE IF EXISTS counties_2010_metrics;
